-- Tüm yerleşik aktiviteler için tek program satırı (FK için yeterli)
-- duration / exercise_count NOT NULL — placeholder değerler
...
-- Kategori kısıtı sorunlu satırları güvenli kategoriye çek
...
-- Eksik yerleşik program satırlarını ekle (önceki migration atlandıysa)
INSERT INTO training_programs (
    id, name, category, difficulty, duration, calories_burn, exercise_count, is_active
)
VALUES
